...
public class JobSeekerManager implements JobSeekerService {
		...
		public Result add(JobSeeker jobSeeker) {
		   ...
		   /*else if(!identityValidation.(jobSeeker.getIdentityNumber()))
			...
			else if(this.jobSeekerDao.findByEmail(jobSeeker.getEmail())!=null){    //Tamamdır
				return new ErrorResult("E posta adresiniz sistemde kayıtlıdır");
			}
			else if(this.jobSeekerDao.findByIdentityNumber(jobSeeker.getIdentityNumber())!=null) { //Tamamdır
